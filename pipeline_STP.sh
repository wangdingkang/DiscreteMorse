...
# Remove edges close to boundary.
python ./Code/Simplification/BoundaryEdgeRemover.py $work_space
...
python ./Code/Simplification/Simplifier.py $work_space LEAF -r [10,10,50]
